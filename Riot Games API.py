...
def rankDisplay(summonername,champ_id):
    ...
    data = data['data']
    for champ in data:
        Champions[int(data[champ]['id'])] = data[champ]['name']
    print(summonername + ' :: ' + Champions[champ_id]  + ' - Mastery ' + str(masterylvl) )       
    print(rank + ' Winrate: ' +  str(round(int((wins/((wins + losses))) * 100)))+ '%')
    # -- End --
...
for player in GameJson['participants']:
    if player['teamId'] == 100:
        BlueTeam[player['summonerName']] = player
    elif player['teamId'] == 200:
        RedTeam[player['summonerName']] = player

print(RedTeam)
print(BlueTeam)

for player in RedTeam:
    print('__________________________________RED TEAM__________________________________)')
    print(player)
    summonername = player
    champ_id = GameJson['participants'][player]['championId']
    rankDisplay(summonername,champ_id)

for player in BlueTeam:
    print('__________________________________BLUE TEAM__________________________________)')
    print(player)
    summonername = player
    champ_id = GameJson['participants'][player]['championId']
    rankDisplay(summonername,champ_id)
